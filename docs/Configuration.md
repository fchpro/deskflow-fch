...
| leftCtrlSuperSwapScreen | Client canonical screen name | Windows server fork: swap left Ctrl/Super only for this client. Empty/unset disables. Right-side and primary-screen input stay unchanged. Restart GUI/core after editing. |
