...
public:
  ...
  struct Server
  {
    ...
    inline static const auto ExcludedApps = QStringLiteral("server/excludedApps");
    ...
    inline static const auto LeftCtrlSuperSwapScreen = QStringLiteral("server/leftCtrlSuperSwapScreen");
    inline static const auto MouseSendRateHz = QStringLiteral("server/mouseSendRateHz");
...
private:
  ...
  inline static const QStringList m_validKeys = {
    ...
    , Server::GridWidth
    , Server::Heartbeat
    , Server::LeftCtrlSuperSwapScreen
    , Server::MouseSendRateHz
    , Server::Protocol
